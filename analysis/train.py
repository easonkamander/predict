...
model = Sequential()
model.add(LSTM(200, input_shape=(load.MAX_QUESTIONS, load.TOTAL_FEATURES), return_sequences=True))
...
model.fit(trainX, trainY, epochs=150, validation_data=(checkX, checkY), shuffle=True)
